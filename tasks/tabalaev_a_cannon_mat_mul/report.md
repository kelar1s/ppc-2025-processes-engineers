...
Для сравнения производительности использовалась матрица размером `504x504`.
...
|------------------|---------------------|------------------------|-----------|---------------|
| **MPI (1 процесс)** | | | | |
| pipeline | 1 | 0.0353456400 | 1.00x | — |
| task_run | 1 | 0.0348083000 | 1.00x | — |
| **MPI (4 процесса)** | | | | |
| pipeline | 4 | 0.0179252600 | 1.97x | 49% |
| task_run | 4 | 0.0132637600 | 2.62x | 66% |
| **MPI (9 процессов)** | | | | |
| pipeline | 9 | 0.0140101800 | 2.52x | 28% |
| task_run | 9 | 0.0136480400 | 2.55x | 28% |
| **MPI (16 процессов)** | | | | |
| pipeline | 16 | 0.0547407600 | 0.65x | 4% |
| task_run | 16 | 0.0606210800 | 0.57x | 4% |
...
- На 4 процессах (решетка 2x2) достигнуто ускорение в 2.62x при эффективности 66%.
